...
var syncModel = function syncSingleModel(modelName) {
  return new Promise(function modelSync(resolve, reject) {
    var getDataPromises = [
      HerokuData.getColumns(modelName.toLocaleString()),
      salesforceData.describeForceObject(modelName)
    ];
    ...
    Promise
      ...
      .then(SequelizeHelper.updateModel.bind(SequelizeHelper, modelName))
      .then(function () {
