...
let TestGenerator = require('./test-generator');
...
`;
  ...
  generateEndpoints() {
    ...
    return Promise
      ...
      .then(function () {
        return _this.testGenerator.writeDataFile(_this.displayName);
      })
      .then(function () {
        return _this.testGenerator.writeLibFile(_this.displayName, _this.endpointConfig);
      })
      .catch((error) => {
        console.log(error);
      });
